...
## Purpose
Handles kitchen order processing, acceptance, and rejection logic. Listens for order events and updates kitchen state accordingly.
...
## API Endpoints
- `/health` – Health check
- [Swagger/OpenAPI docs](http://localhost:3004/docs) (if available)
